...
input_Emma = Input(
    ...
    # input_folder="~/scratch/ixi/input/",
    # output_folder="~/scratch/ixi/output/",
    automesh="/projectnb/lejlab/ANU_ABAQUS/automesh/target/release/automesh",
    input_folder="/projectnb/lejlab/ANU_ABAQUS/autosim/ensemble_npy_arrays",
    output_folder="/projectnb/lejlab/ANU_ABAQUS/autosim/abaqus_mesh",
    output_type=".inp",
    remove=[0],
...
SCALES: Final[dict] = {
    ...
    "run1": SCALING[LENGTH_SCALE] / RESOLUTION["run1"]
}
